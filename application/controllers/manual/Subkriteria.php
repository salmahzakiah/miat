...
class Subkriteria extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('manual/subkriteria/index', $data);
    ...
    public function tambahsub($kriteria)
    {
        ...
        $submenu = "<a href=" . base_url('manual/subkriteria') . ">Konfigurasi Sub Kriteria</a> /";
        $data = [
            'spk' => 'subkriteria',
            'title' => $title,
            'nama_user' => $nama_user,
        ...
        $this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
        $this->load->view('manual/subkriteria/tambah_subkriteria', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit_sub($id_subkriteria)
    {
        ...
        $this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
        $this->load->view('manual/subkriteria/edit_subkriteria', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function insert_subKrit($kriteria)
    {
        ...
        if ($insert == 1) {
            ...
            redirect('manual/subkriteria/tambahsub' . $kriteria);
        }
    }
    ...
    public function perband_sub($id_krit)
    {
        ...
        $this->load->view('templates/sidebar', $data);
		$this->load->view('templates/topbar', $data);
        $this->load->view('manual/subkriteria/perband_subkriteria', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function subkriteria_masuk($jum, $id_kriteria)
    {
        ...
        if ($cek_jumlah == 0) {
            ...
            if ($insert == 1) {
                echo "Sukses Insert";
                redirect('manual/proses/proses_subkriteria/' . $id_kriteria);
            } else {
                echo "Gagal Insert";
                redirect('manual/subkriteria/perband_sub/' . $id_kriteria);
            }
        } else {
            for ($i = 0; $i < $jum; $i++) {
                $data = [
    ...
    public function tambahpekerjaansama($id_subkrit)
    {
        ...
        if ($insert == 1) {
            ...
            redirect('manual/subkriteria/edit_sub/' . $id_subkrit);
        } else {
            echo "Gagal Insert";
