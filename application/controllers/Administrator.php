...
class Administrator extends CI_Controller
{
 ...
 // Periode 
        $total_periode = $this->model_periode->tahun_periode();
        $periode = $this->model_periode->getCountSiswaPerPeriode()->result_array();

        // Pekerjaan
        $pekerjaan = $this->model_siswa->get_sum_pekerjaan()->result_array();

        // Data
        $siswa = $this->model_siswa->data_siswa();
        ...
        $data['total_data'] = $siswa->num_rows();
