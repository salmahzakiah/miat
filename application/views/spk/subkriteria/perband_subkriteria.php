            ...
            <form action="<?= base_url('spk/subkriteria/subkriteria_masuk/') . $jum_perbandingan . '/' . $id_krit; ?>" method="POST">
                ...
                <table class="table table-bordered" style="max-width: 40rem;">
                    <thead>
						...
						<th scope="col" class="align-middle"style="text-align: center;border: 1px solid #d5d5db;">SubKriteria1</th>
                            <th style="text-align: center;border: 1px solid #d5d5db;">Nilai perbandingan</th>
							<th scope="col" class="align-middle"style="text-align: center;border: 1px solid #d5d5db;">SubKriteria2</th>
                        </tr>
                    </thead>
