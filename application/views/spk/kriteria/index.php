    ...
    <div class="card rounded">
        <div class="card-body">
            ...
            <form action="<?= base_url('spk/kriteria/kriteria_masuk/') . $jum_perbandingan; ?>" method="POST">
				...
				<a href="<?= base_url('spk/subkriteria/'); ?>" class="btn  btn-success">Subkriteria</a>
                ...
                <table class="table table-bordered" style="max-width: 40rem;">
                    <thead>
						...
						<th scope="col" class="align-middle"style="border: 1px solid #d5d5db;text-align: center;">Kriteria 1</th>
                            <th style="text-align: center;border: 1px solid #d5d5db;">Nilai perbandingan</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;text-align: center;">Kriteria 2</th>
                        </tr>
                    </thead>
