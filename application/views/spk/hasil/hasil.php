                ...
                <table id="example" class="table table-bordered text-center">
                    <thead style="font-size: 13px;background-color: #d9edf7;">
                        <tr>
                            ...
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Nama Periode</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Tanggal Periode</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Kuota</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Keterangan</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Implementasi AHP</th>
                        </tr>
                    </thead>
                    <tbody style="font-size: 13px;">
                        ...
                        <?php foreach ($periode as $p) : ?>
                            <tr>
                                ...
                                <td><?= $p['keterangan']; ?></td>
                                <td style="width:30px;">
								<a href="<?= base_url('spk/hasil/cek_implementasi/') . $p['id_periode']; ?>" class="btn btn-primary <?php if ($button != 0) echo "disabled"; ?>"><i class="bi bi-arrow-right-square"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
