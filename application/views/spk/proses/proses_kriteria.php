...
<div class="m-3">
	...
	<div class="m-3"></div></div>
            ...
            <div class="d-flex flex-row-reverse">
                <a href="<?= base_url('spk/proses/proses_kriteria/1'); ?>" class="btn btn-primary <?php if ($cons_rasio > 0.1) echo "disabled"; ?>">Lanjut Step<i class="bi bi-arrow-right-short"></i></a>
                <a href="<?= base_url('spk/proses'); ?>" class="btn btn-warning mr-2"><i class="bi bi-arrow-left-short"></i>Kembali</a>
            </div>
            <hr>
            ...
            <table class="table table-bordered" style="max-width: 60rem;">
                <thead class="align-middle">
                    ...
                    <tr style="background-color: #d9edf7; font-size: 13px;" class="text-center">
                ...
                <tbody style="font-size: 13px;">
                    ...
                    for ($x = 0; $x < $n; $x++) {
                        echo "<tr>";
                        echo "<td style='background-color: #d9edf7; ' class='font-weight-bold'>" . $kriteria_arr[$x] . "</td>";
                        for ($y = 0; $y < $n; $y++) {
