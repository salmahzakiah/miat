            ...
            <table class="table table-bordered" style="max-width: 40rem;">
                <thead>
                    <tr style="background-color: #d9edf7;  font-size: 13px;">
                        <th class="align-middle" style="width: 20px;border: 1px solid #d5d5db;text-align: center;">No</th>
                        <th class="align-middle"style="width: 20px;border: 1px solid #d5d5db;text-align: center;">Kriteria</th>
                        <th class="align-middle text-center" style="width: 40px;border: 1px solid #d5d5db;text-align: center;">
                        ...
                        <th class=" align-middle"style=" border: 1px solid #d5d5db; text-align: center;">Subkriteria
                        </th>
                        <th class="align-middle text-center" style="width: 100px; border: 1px solid #d5d5db;">Bobot<br> Subkriteria</th>
                        <th class="align-middle text-center" style="width: 40px; border: 1px solid #d5d5db;">Cek <br> Proses</th>
                    </tr>
                </thead>
