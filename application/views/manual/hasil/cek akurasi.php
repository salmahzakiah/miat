        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="mr-auto bd-highlight">
                    <a href="<?= base_url('manual/hasil/scoring/') . $id_periode; ?>" class="btn btn-warning"><span><i class="bi bi-arrow-left"></i> Kembali</span> </a>
                </div>
                <div class="">
            ...
            <div>
                ...
                <form method="POST" action="<?= base_url('manual/hasil/cek_akurasi/') . $id_periode; ?>" enctype="multipart/form-data">
