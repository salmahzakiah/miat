            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto bd-highlight">
                    <?php if (!count($error_data) > 0) { ?>
                        <a href="<?= base_url('manual/hasil/implementWBobot/') . $id_periode; ?>" class="btn btn-primary"><span>Lanjut Proses</span> <i class="bi bi-arrow-right"></i></a>
                    <?php } else { ?>
                ...
                <table id="example" class="table table-bordered text-center">
                    <thead style="font-size: 13px;background-color: #d9edf7;">
                        <tr>
                            ...
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Kelas</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Nama OrangTua</th>
                            ...
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Jumlah Saudara</th>
                            <th scope="col" class="align-middle"style="border: 1px solid #d5d5db;">Status Siswa</th>
                        </tr>
                    </thead>
